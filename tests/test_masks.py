...
from tests.conftest import card_number_1, empty_number, account_1
...
def test_get_mask_card_number_1(card_number_1, empty_number):
...
def test_get_mask_account_1(account_1, empty_number):
